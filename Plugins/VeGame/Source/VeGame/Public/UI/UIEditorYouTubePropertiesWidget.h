...
#include "UIEditorYouTubePropertiesWidget.generated.h"
 ...
 */
UCLASS(HideDropdown)
class VEGAME_API UUIEditorYouTubePropertiesWidget : public UUIPlaceablePropertiesWidget, public IManagedTextureRequester {
	GENERATED_BODY()
