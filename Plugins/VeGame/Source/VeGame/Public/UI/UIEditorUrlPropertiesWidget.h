...
#include "UIEditorUrlPropertiesWidget.generated.h"
 ...
 */
UCLASS(HideDropdown)
class VEGAME_API UUIEditorUrlPropertiesWidget : public UUIPlaceablePropertiesWidget, public IManagedTextureRequester {
	GENERATED_BODY()
