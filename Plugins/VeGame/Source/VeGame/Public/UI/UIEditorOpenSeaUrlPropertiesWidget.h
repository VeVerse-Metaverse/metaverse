...
#include "UIEditorOpenSeaUrlPropertiesWidget.generated.h"
 ...
 */
UCLASS(HideDropdown)
class VEGAME_API UUIEditorOpenSeaUrlPropertiesWidget : public UUIPlaceablePropertiesWidget, public IManagedTextureRequester {
	GENERATED_BODY()
...
public:
	...
	void SetOriginalUrl(const FString& InUrl);
	FString GetUrl();
};
