...
#include "PlaceableOpenSeaCanvas.generated.h"
...
class VEGAME_API APlaceableOpenSeaCanvas final : public APlaceableUrlOpenSea, public IManagedTextureRequester {
	GENERATED_BODY()

public:
	APlaceableOpenSeaCanvas();
