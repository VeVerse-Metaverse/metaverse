...
#include "UIUserListPageWidget.generated.h"
 ...
 */
UCLASS(HideDropdown)
class VEUI_API UUIUserListPageWidget final : public UUIPageContentWidget {
	GENERATED_BODY()
...
protected:
	...
	void OnMetadataResponse(const FApiUserBatchMetadata& InMetadata, bool bSuccessful, const FString& Error);
