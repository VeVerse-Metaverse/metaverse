...
#include "UIObjectFilterWidget.generated.h"

/**
 * 
 */
UCLASS()
class VEUI_API UUIObjectFilterWidget : public UUIWidgetBase
 {
	GENERATED_BODY()
...
public:
	DECLARE_EVENT_OneParam(UUIObjectFilterWidget, FOnFilterChanged, const FString&);
