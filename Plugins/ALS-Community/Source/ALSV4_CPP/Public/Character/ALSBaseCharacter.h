...
#pragma region LE7EL - Names
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "ALS|Bones")
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "ALS|Bones")
	FName LowerSpineBoneName = TEXT("spine_03");

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "ALS|Sockets")
	FName PelvisSocketName = TEXT("Pelvis");

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "ALS|Sockets")
	FName FPCameraSocketName = TEXT("FP_Camera");
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "ALS|Poses")
	FName RagdollPoseName = TEXT("RagdollPose");

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "ALS|Curves")
	FName RotationAmountCurveName = TEXT("RotationAmount");

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "ALS|Curves")
	FName YawOffsetCurveName = TEXT("YawOffset");
#pragma endregion 
...
protected:
	...
	FTimerHandle HackGait_TimerHandle;
	FTimerDelegate HackGait_TimerDelegate;
	FTimerHandle HackGait_TimerHandle2;
	FTimerDelegate HackGait_TimerDelegate2;
...
protected:
	...
	UPROPERTY(BlueprintReadOnly, Category = "ALS|State Values")
	EALSGait Gait = EALSGait::Running;
