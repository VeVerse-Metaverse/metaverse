...
#pragma region LE7EL - Names
	...
	FName LeftHandAttachBone = TEXT("VB LHS_ik_hand_gun");

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "ALS|Bones")
	FName RightHandAttachBone = TEXT("VB RHS_ik_hand_gun");

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "ALS|Sockets")
	FName LeftCameraTraceSocket = TEXT("TP_CameraTrace_L");

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "ALS|Sockets")
	FName RightCameraTraceSocket = TEXT("TP_CameraTrace_R");
#pragma endregion 
