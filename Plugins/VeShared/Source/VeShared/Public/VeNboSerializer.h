 ...
 */
class VESHARED_API FVeNboSerializeToBuffer {
	/** Hidden on purpose */
	FVeNboSerializeToBuffer(void);
...
public:
	 ...
	 */
	FVeNboSerializeToBuffer(uint32 Size)
		: NumBytes(0),
	 ...
	 */
	friend inline FVeNboSerializeToBuffer& operator<<(FVeNboSerializeToBuffer& Ar, const bool B) {
		Ar << (uint8)B;
	 ...
	 */
	friend inline FVeNboSerializeToBuffer& operator<<(FVeNboSerializeToBuffer& Ar, const char Ch) {
	 ...
	 */
	friend inline FVeNboSerializeToBuffer& operator<<(FVeNboSerializeToBuffer& Ar, const uint8& B) {
		if (!Ar.HasOverflow() && Ar.NumBytes + 1 <= Ar.GetBufferSize()) {
	...
	friend inline FVeNboSerializeToBuffer& operator<<(FVeNboSerializeToBuffer& Ar, const TEnumAsByte<TEnum>& B) {
		return Ar << *(uint8*)&B;
	}
	 ...
	 */
	friend inline FVeNboSerializeToBuffer& operator<<(FVeNboSerializeToBuffer& Ar, const int32& I) {
		return Ar << *(uint32*)&I;
	}
	 ...
	 */
	friend inline FVeNboSerializeToBuffer& operator<<(FVeNboSerializeToBuffer& Ar, const uint32& D) {
	 ...
	 */
	friend inline FVeNboSerializeToBuffer& operator<<(FVeNboSerializeToBuffer& Ar, const uint64& Q) {
	 ...
	 */
	friend inline FVeNboSerializeToBuffer& operator<<(FVeNboSerializeToBuffer& Ar, const float& F) {
	 ...
	 */
	friend inline FVeNboSerializeToBuffer& operator<<(FVeNboSerializeToBuffer& Ar, const double& Dbl) {
	 ...
	 */
	friend inline FVeNboSerializeToBuffer& operator<<(FVeNboSerializeToBuffer& Ar, const FString& String) {
	 ...
	 */
	friend inline FVeNboSerializeToBuffer& operator<<(FVeNboSerializeToBuffer& Ar, const TCHAR* String) {
	 ...
	 */
	inline FVeNboSerializeToBuffer& AddString(const ANSICHAR* String, const int32 Length) {
		// We send strings length prefixed
		int32 Len = Length;
		(*this) << Len;
	 ...
	 */
	friend inline FVeNboSerializeToBuffer& operator<<(FVeNboSerializeToBuffer& Ar, const FName& Name) {
	 ...
	 */
	friend inline FVeNboSerializeToBuffer& operator<<(FVeNboSerializeToBuffer& Ar, const FInternetAddr& Addr) {
	...
	/**
	 * Adds a FVector to the buffer
	 */
	friend inline FVeNboSerializeToBuffer& operator<<(FVeNboSerializeToBuffer& Ar, const FVector& Guid) {
		Ar << Guid.X;
		Ar << Guid.Y;
		Ar << Guid.Z;
		return Ar;
	 ...
	 */
	friend inline FVeNboSerializeToBuffer& operator<<(FVeNboSerializeToBuffer& Ar, const FGuid& Guid) {
		Ar << Guid.A;
		Ar << Guid.B;
		Ar << Guid.C;
		Ar << Guid.D;
	...
	template <typename T>
	friend inline FVeNboSerializeToBuffer& operator <<(FVeNboSerializeToBuffer& Ar, const T& Value) {
		static_assert(VeNboSerializer::UnexpectedType<T>, "Unsupported type in FNboSerializeToBuffer::operator<<");
...
/**
 * Class used to read data from a NBO (network byte order) data buffer
 */
class VESHARED_API FVeNboSerializeFromBuffer {
protected:
	...
	/** Hidden on purpose */
	FVeNboSerializeFromBuffer(void);
...
public:
	 ...
	 */
	FVeNboSerializeFromBuffer(const uint8* InData, int32 Length)
		: Data(InData),
		  NumBytes(Length),
		  CurrentOffset(0),
		  bHasOverflowed(false) { }
	 ...
	 */
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, bool& B) {
		uint8 Read = 0;
		Ar >> Read;
		B = !!Read;
	 ...
	 */
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, char& Ch) {
	 ...
	 */
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, uint8& B) {
		if (!Ar.HasOverflow() && Ar.CurrentOffset + 1 <= Ar.NumBytes) {
	 ...
	 */
	template <class TEnum>
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, TEnumAsByte<TEnum>& B) {
		return Ar >> *(uint8*)&B;
	}
	 ...
	 */
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, uint16& D) {
		if (!Ar.HasOverflow() && Ar.CurrentOffset + 2 <= Ar.NumBytes) {
			D = ((uint16)Ar.Data[Ar.CurrentOffset + 0] << 8) |
				((uint16)Ar.Data[Ar.CurrentOffset + 1]);
			Ar.CurrentOffset += 2;
		} else {
			Ar.bHasOverflowed = true;
		}
	 ...
	 */
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, int32& I) {
		return Ar >> *(uint32*)&I;
	}
	 ...
	 */
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, uint32& D) {
	 ...
	 * Adds a uint64 to the buffer
	 */
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, uint64& Q) {
	 ...
	 */
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, float& F) {
		return Ar >> *(uint32*)&F;
	}
	 ...
	 */
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, double& Dbl) {
	 ...
	 */
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, FString& String) {
		// We send strings length prefixed
		int32 Len = 0;
		Ar >> Len;
	 ...
	 */
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, FName& Name) {
		FString NameString;
		Ar >> NameString;
	 ...
	 */
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, FInternetAddr& Addr) {
	...
	/**
	 * Reads a FVector from the buffer
	 */
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, FVector& Guid) {
		Ar >> Guid.X;
		Ar >> Guid.Y;
		Ar >> Guid.Z;
		return Ar;
	 ...
	 */
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, FGuid& Guid) {
		Ar >> Guid.A;
		Ar >> Guid.B;
		Ar >> Guid.C;
		Ar >> Guid.D;
	 ...
	 */
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, FQualifiedFrameTime& FrameTime) {
		int32 FrameNumber;
		float SubFrame;
	...
	// This will be chosen in case of any type not specially supported
	template <typename T>
	friend inline FVeNboSerializeFromBuffer& operator>>(FVeNboSerializeFromBuffer& Ar, T& Value) {
		static_assert(VeNboSerializer::UnexpectedType<T>, "Unsupported type in FVeNboSerializeFromBuffer::operator>>");
